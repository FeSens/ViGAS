...
lappend arg_list "--component-param=SEQ_ROM=god_bless_apollo_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=god_bless_apollo_mem_if_ddr3_emif_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=god_bless_apollo_mem_if_ddr3_emif_0_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=god_bless_apollo_mem_if_ddr3_emif_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:god_bless_apollo_mem_if_ddr3_emif_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:god_bless_apollo_mem_if_ddr3_emif_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/opt/altera/14.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
