// Instrument_Unit_mem_if_ddr3_emif_fpga.v
...
`timescale 1 ps / 1 ps
module Instrument_Unit_mem_if_ddr3_emif_fpga (
	...
	Instrument_Unit_mem_if_ddr3_emif_fpga_pll0 pll0 (
	...
	Instrument_Unit_mem_if_ddr3_emif_fpga_p0 p0 (
		.global_reset_n             (global_reset_n),                                                                                                                                                                            //        global_reset.reset_n
	...
	Instrument_Unit_mem_if_ddr3_emif_fpga_s0 s0 (
		.avl_clk                 (p0_avl_clk_clk),                               //          avl_clk.clk
		.avl_reset_n             (p0_avl_reset_reset),                           //        avl_reset.reset_n
		.scc_clk                 (p0_scc_clk_clk),                               //          scc_clk.clk
	...
	Instrument_Unit_mem_if_ddr3_emif_fpga_dmaster #(
		.USE_PLI     (0),
		.PLI_PORT    (50000),
		.FIFO_DEPTHS (2)
	) dmaster (
	...
	Instrument_Unit_mem_if_ddr3_emif_fpga_mm_interconnect_1 mm_interconnect_1 (
