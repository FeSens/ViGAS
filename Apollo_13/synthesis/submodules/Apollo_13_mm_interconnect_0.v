...
`timescale 1 ps / 1 ps
module Apollo_13_mm_interconnect_0 (
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (pio_0_s1_agent_rdata_fifo_out_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (pio_0_s1_agent_rdata_fifo_out_valid),          //                .valid
		.rdata_fifo_sink_data    (pio_0_s1_agent_rdata_fifo_out_data),           //                .data
	...
	Apollo_13_mm_interconnect_0_router router (
	...
	Apollo_13_mm_interconnect_0_router router_001 (
	...
	Apollo_13_mm_interconnect_0_router_002 router_002 (
	...
	Apollo_13_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Apollo_13_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Apollo_13_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Apollo_13_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Apollo_13_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Apollo_13_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
